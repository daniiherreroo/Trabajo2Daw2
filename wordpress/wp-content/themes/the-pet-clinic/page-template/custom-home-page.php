		...
		<section id="slider">
		  	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
			    ...
			    <div class="carousel-inner" role="listbox">
			        ...
			        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
			          	...
			          	<div class="carousel-caption">
				            ...
				            <div class="read-btn">
			            		<a href="<?php the_permalink(); ?>" title="<?php esc_attr_e( 'VIEW PROJECTS', 'the-pet-clinic' ); ?>" ><?php esc_html_e('VIEW PROJECTS','the-pet-clinic'); ?><span class="screen-reader-text"><?php esc_html_e('VIEW PROJECTS','the-pet-clinic'); ?></span></a>
					       	</div>
			          	</div>
			        </div>
			      	<?php $i++; endwhile; 
			    ...
			    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
		      		...
		      		<span class="screen-reader-text"><?php esc_html_e( 'Previous','the-pet-clinic' );?></span>
			    </a>
			    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
		      		<span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
		      		<span class="screen-reader-text"><?php esc_html_e( 'Next','the-pet-clinic' );?></span>
			    </a>
		  	</div>  
						...
						<div class="col-lg-4">
							<div class="row">
								...
								<div class="facilities_left col-lg-9 col-md-9">
									...
									<div class="read-more">
										<a href="<?php the_permalink(); ?>"><?php esc_html_e('Read Details','the-pet-clinic'); ?><span class="screen-reader-text"><?php esc_html_e( 'Read Details','the-pet-clinic' );?></span></a>
									</div>
								</div>
								<?php endwhile; 
							      	wp_reset_postdata();
